...
.ac-qs{
  ...
  border-bottom:1px solid var(--g2);padding:8px 20px;display:flex;gap:10px;flex-wrap:wrap;align-items:center;
}
.ac-qi{
  display:flex;align-items:center;gap:6px;
  background:linear-gradient(135deg,var(--bl) 0%,#d4e8f8 100%);
